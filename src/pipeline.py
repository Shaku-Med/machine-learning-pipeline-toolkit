...
from src.monitoring.drift_detector import ModelMonitor
...
@flow(name="ML Pipeline Orchestration")
def run_ml_pipeline(
    data_path: str,
    target_column: str,
    ...
    try:
        ...
        logger.error("ML Pipeline orchestration failed", error=str(e))
        raise e
...
def create_sample_data():
    ...
    logger.info("Sample data created", file_path=str(data_path / "sample_data.csv"))
